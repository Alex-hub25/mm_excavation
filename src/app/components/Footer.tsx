        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex space-x-4">
              <a
                href="#"
                className="w-10 h-10 bg-gray-800 rounded-lg flex items-center justify-center hover:bg-[#e67e22] transition-colors duration-200"
              >
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center md:text-left">
            <div className="flex items-center justify-center md:justify-start space-x-3">
              ...
              <div>
                <div className="font-medium">1234 Construction Way</div>
                <div className="text-gray-400 text-sm">Yourtown, ST 12345</div>
              </div>
            </div>
            ...
            <div className="flex items-center justify-center md:justify-start space-x-3">
              ...
              <div>
                <div className="font-medium">info@mmexcavation.com</div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-gray-400 text-sm mb-2 md:mb-0">
              © 2024 M & M Excavation and Dirtwork. All rights reserved.
            </div>
